        ...
        <Card style={{ height: "96px", padding: 0 }}
            ...
            <div style={{ display: "flex", justifyContent: "space-between" }}>
                <Text size="xxxl" strong style={{
                    flex: 1, whiteSpace: 'nowrap', flexShrink: 0,
                    textAlign: 'start', marginLeft: "48px", fontVariantNumeric: "tabular-nums"
                }}>
                    {isLoading ? (<Skeleton.Button style={{ marginTop: '8px', width: "74px" }} />)
                        : totalCount}
